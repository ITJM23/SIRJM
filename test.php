            ...
            <div id="job1" class="accordion-collapse collapse show" data-bs-parent="#workExperienceAccordion">
                <div class="accordion-body">
                    <ul>
                        ...
                        <li>Managed <strong>Windows Server</strong>, performing regular updates, security patches, and Active Directory administration.</li>
                        <li>Resolved <strong>network configuration issues</strong>, VPN setup, and cloud computing integration (<strong>AWS, Azure, Google Cloud</strong>).</li>
